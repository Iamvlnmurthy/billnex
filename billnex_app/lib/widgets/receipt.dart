...
class ReceiptView extends StatelessWidget {
                  ...
                  (l) => Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(
                          width: 28,
                          child: Text(qtyLabel(l.qty), textAlign: TextAlign.center, style: const TextStyle(fontSize: 11)),
                        ),
                        SizedBox(
                          width: 70,
                          child: Text(money(l.amount), textAlign: TextAlign.right, style: const TextStyle(fontSize: 11)),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _tableHeader(bool bilingual) {
    ...
    return Row(
      children: [
        Expanded(
          child: Text(th[0], style: const TextStyle(fontSize: 10.5, color: Color(0xFF666666))),
        ),
        SizedBox(
          width: 28,
          child: Text(
...
class _QrPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const bits = [0x7F, 0x41, 0x5D, 0x5D, 0x41, 0x7F, 0x2A];
    for (int y = 0; y < n; y++) {
      for (int x = 0; x < n; x++) {
