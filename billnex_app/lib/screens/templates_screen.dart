...
class TemplatesScreen extends StatelessWidget {
  ...
  static const _demo = [
    RcptLine('Product one', 2, 620),
    RcptLine('Service item', 1, 620),
  ];
          ...
          child: Row(children: [
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(template.desc, style: TextStyle(fontSize: 11.5, color: bx.muted), maxLines: 1, overflow: TextOverflow.ellipsis),
              ]),
            ),
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              ...
              if (isDefault)
                Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const SizedBox(width: 4),
                  Text('Default', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: bx.pos)),
                ])
              else
                TextButton(
                  onPressed: () {
