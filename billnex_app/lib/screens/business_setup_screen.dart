...
class _BusinessSetupScreenState extends State<BusinessSetupScreen> {
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                ...
                if (!_editing)
                  Padding(
                    ...
                    child: Text('You can change any of this later in Settings. Your catalogue starts empty — add your own products next.',
                        textAlign: TextAlign.center, style: TextStyle(fontSize: 12, color: bx.faint)),
                  ),
              ]),
            ),
          ],
  ...
  Widget _field(TextEditingController c, String label,
      {String? hint, TextInputType? keyboard, int maxLines = 1, bool caps = false, bool autofocus = false, String? Function(String?)? validator}) {
    return Padding(
