...
class LTe extends L {
  ...
  @override
  String get appName => 'బిల్‌నెక్స్';

  @override
  String get navDashboard => 'డాష్‌బోర్డ్';

  @override
  String get navBilling => 'బిల్లింగ్';

  @override
  String get navSales => 'అమ్మకాలు';

  @override
  String get navCustomers => 'వినియోగదారులు';

  @override
  String get navInventory => 'నిల్వ';

  @override
  String get navPurchases => 'కొనుగోళ్లు';

  @override
  String get navReports => 'నివేదికలు';

  @override
  String get navFeatures => 'ఫీచర్లు';

  @override
  String get navPrint => 'ప్రింట్';
  ...
  @override
  String get queue => 'క్యూ';

  @override
  String get backup => 'బ్యాకప్';

  @override
  String get currentBill => 'ప్రస్తుత బిల్లు';
  ...
  @override
  String get credit => 'అరువు';

  @override
  String get chargeAndPrint => 'చెల్లించి ప్రింట్ చేయండి';

  @override
  String get walkInCustomer => 'వాక్-ఇన్ కస్టమర్ · జోడించడానికి నొక్కండి';

  @override
  String get startBilling => 'బిల్లింగ్ ప్రారంభించండి';
  ...
  @override
  String get quickBill => 'క్విక్ బిల్';

  @override
  String get tally => 'టాలీ';

  @override
  String get itemized => 'వస్తువుల వారీగా';
  ...
  @override
  String get collect => 'వసూలు చేయి';

  @override
  String get discount => 'తగ్గింపు';

  @override
  String get roundOff => 'రౌండ్ ఆఫ్';
  ...
  @override
  String get frequent => 'తరచుగా';

  @override
  String get cashReceived => 'నగదు స్వీకరించారు (ఐచ్ఛికం)';

  @override
  String get returnChange => 'చిల్లర తిరిగి ఇవ్వండి';

  @override
  String get upi => 'UPI';

  @override
  String get khataCredit => 'ఖాతా (అరువు)';

  @override
  String get clearBill => 'బిల్లు క్లియర్ చేయి';

  @override
  String get amountToCollect => 'వసూలు చేయాల్సిన మొత్తం';

  @override
  String get punchAmounts => 'ప్రతి మొత్తాన్ని నమోదు చేసి, ఆపై వసూలు చేయండి';

  @override
  String get noCatalogueNeeded => 'వస్తువుల పేర్లు లేదా జాబితా అవసరం లేదు.';

  @override
  String get guidedSetup => 'గైడెడ్ సెటప్ · 60 సెకన్లు';

  @override
  String get businessType => 'వ్యాపార రకం';

  @override
  String get chooseYourTrade => 'మీ వ్యాపారాన్ని ఎంచుకోండి';

  @override
  String get continueLabel => 'కొనసాగించు';

  @override
  String get skipStandardStore => 'దాటవేయి — ప్రామాణిక స్టోర్‌తో ప్రారంభించు';

  @override
  String get menu => 'మెను';

  @override
  String get myBusiness => 'నా వ్యాపారం';
